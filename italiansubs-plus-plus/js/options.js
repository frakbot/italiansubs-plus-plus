...
window.onload = function() {
  ...
  $('table.options-table tr td a span.ui-icon').parent().parent().parent().find('div.toggle').toggle('blind', undefined, -1);

  // Eseguo il binding del click su tutti i pulsanti toggle
  $('table.options-table tr td a span.ui-icon').parent().click(function() {
    var options;
